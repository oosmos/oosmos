...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/MatrixExample.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=oosmos.c pin.c main.c sw.c matrix.c prt.c matrixtest.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/oosmos.o ${OBJECTDIR}/pin.o ${OBJECTDIR}/main.o ${OBJECTDIR}/sw.o ${OBJECTDIR}/matrix.o ${OBJECTDIR}/prt.o ${OBJECTDIR}/matrixtest.o
POSSIBLE_DEPFILES=${OBJECTDIR}/oosmos.o.d ${OBJECTDIR}/pin.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/sw.o.d ${OBJECTDIR}/matrix.o.d ${OBJECTDIR}/prt.o.d ${OBJECTDIR}/matrixtest.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/oosmos.o ${OBJECTDIR}/pin.o ${OBJECTDIR}/main.o ${OBJECTDIR}/sw.o ${OBJECTDIR}/matrix.o ${OBJECTDIR}/prt.o ${OBJECTDIR}/matrixtest.o

# Source Files
SOURCEFILES=oosmos.c pin.c main.c sw.c matrix.c prt.c matrixtest.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/MatrixExample.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/matrix.o: matrix.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/matrix.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PIC32MXSK=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -ffunction-sections -fdata-sections -DPIC32_STARTER_KIT -D__PIC32MX -MMD -MF "${OBJECTDIR}/matrix.o.d" -o ${OBJECTDIR}/matrix.o matrix.c   
...
${OBJECTDIR}/matrix.o: matrix.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/matrix.o.d 
	@${RM} ${OBJECTDIR}/matrix.o 
	@${FIXDEPS} "${OBJECTDIR}/matrix.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -ffunction-sections -fdata-sections -DPIC32_STARTER_KIT -D__PIC32MX -MMD -MF "${OBJECTDIR}/matrix.o.d" -o ${OBJECTDIR}/matrix.o matrix.c   
...
${OBJECTDIR}/matrixtest.o: matrixtest.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/matrixtest.o.d 
	@${RM} ${OBJECTDIR}/matrixtest.o 
	@${FIXDEPS} "${OBJECTDIR}/matrixtest.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -ffunction-sections -fdata-sections -DPIC32_STARTER_KIT -D__PIC32MX -MMD -MF "${OBJECTDIR}/matrixtest.o.d" -o ${OBJECTDIR}/matrixtest.o matrixtest.c   
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/MatrixExample.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PIC32MXSK=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/MatrixExample.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}              -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PIC32MXSK=1,--defsym=_min_heap_size=512,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/MatrixExample.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/MatrixExample.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=_min_heap_size=512,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/MatrixExample.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
